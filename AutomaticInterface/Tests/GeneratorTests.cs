        ...
        private async Task RunTestAsync(string code, string expectedResult, NullableContextOptions nullableContextOptions = NullableContextOptions.Disable)
        {
            var tester = new VerifyCS.Test
            {
                ...
                TestState =
                {
                    ...
                    GeneratedSources =
                    {
                        ("AutomaticInterface/AutomaticInterface.AutomaticInterfaceGenerator/GenerateAutomaticInterfaceAttribute.cs",
                            SourceText.From(
@"
using System;
...
";
        ...
        [Fact]
        public async Task WorksWithVerbatimParameters() {
      const string code = @"
using AutomaticInterface;
...
namespace AutomaticInterfaceExample
{
    ...
    public partial interface IDemoClass
    {
        void SomeMethodWithAtSignParameter1(string @class);
        
        void SomeMethodWithAtSignParameter2(string @value);
...
";
      ...
      Assert.True(true); // silence warnings, real test happens in the RunAsync() method
        ...
        [Fact]
        public async Task WorksWithOptionalBooleanParameters() {
      const string code = @"
using AutomaticInterface;
...
namespace AutomaticInterfaceExample
{
    ...
    public partial interface IDemoClass
    {
        void MethodWithBool(bool x = true);
...
";
      ...
      Assert.True(true); // silence warnings, real test happens in the RunAsync() method
        ...
        [Fact]
        public async Task WorksWithOptionalEnumParameters() {
      const string code = @"
using AutomaticInterface;
...
public class DemoClass
{
  public void MethodWithEnum(MyEnum x = MyEnum.A) { }
}
";
...
namespace AutomaticInterfaceExample
{
    ...
    public partial interface IDemoClass
    {
        void MethodWithEnum(AutomaticInterfaceExample.MyEnum x = (AutomaticInterfaceExample.MyEnum)0);
